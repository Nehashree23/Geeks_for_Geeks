<h2><a href="https://www.geeksforgeeks.org/problems/middle-of-three2926/1?page=4&category=Data%20Structures,Algorithms,Arrays,Mathematical,Strings,Dynamic%20Programming,Sorting,Hash,Java,Matrix,Linked%20List,Stack,Binary%20Search,Searching,Binary%20Search%20Tree,sliding-window,Heap,Queue,Map,Divide%20and%20Conquer,set,Pointers&difficulty=Basic&sortBy=submissions">Middle of Three</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given three distinct numbers a, b and c. Find the number with a value in the middle (Try to do it with minimum comparisons).</span></p>
