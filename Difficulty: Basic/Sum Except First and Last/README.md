<h2><a href="https://www.geeksforgeeks.org/problems/max-length-chain/1?page=3&category=Data%20Structures,Algorithms,Arrays,Mathematical,Strings,Dynamic%20Programming,Sorting,Hash,Java,Matrix,Linked%20List,Stack,Binary%20Search,Searching,Binary%20Search%20Tree,sliding-window,Heap,Queue,Map,Divide%20and%20Conquer,set,Pointers&difficulty=Basic&sortBy=submissions">Sum Except First and Last</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">You are given an array <strong>arr</strong> of numbers. Return the sum of all the elements except the first and last elements.</span></p>
