<h2><a href="https://www.geeksforgeeks.org/problems/geek-and-coffee-shop5721/1?page=13&difficulty=Basic&sortBy=submissions">Half N by M</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Given two values <strong>N</strong> and <strong>M</strong>. Give the value when N is halved M-1 times.</span></p>
