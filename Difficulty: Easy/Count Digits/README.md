<h2><a href="https://www.geeksforgeeks.org/problems/count-digits-1606889545--123832/1?page=3&category=Java&difficulty=Easy&sortBy=submissions">Count Digits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a natural number <strong>n</strong>. You have to find the number of digits in it and <strong>return </strong>it.</span></p>
